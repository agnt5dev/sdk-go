...
func (x *ActivationUsage) GetCachedTokens() int64 {
	if x != nil {
		return x.CachedTokens
	}
	return 0
...
type BeginActivationRequest struct {
	...
	// Human-readable name shown on the journal record (step name, tool name,
	// model id). Not part of the activation identity.
	DisplayName string `protobuf:"bytes,13,opt,name=display_name,json=displayName,proto3" json:"display_name,omitempty"`
	// Optional plaintext JSON input rendered on the journal record. Never
	// feeds input_digest; bounded to 64 KiB.
	InputData     []byte `protobuf:"bytes,14,opt,name=input_data,json=inputData,proto3" json:"input_data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BeginActivationRequest) GetDisplayName() string {
	if x != nil {
...
func (x *BeginActivationRequest) GetInputData() []byte {
	if x != nil {
		return x.InputData
	}
	return nil
...
type FailActivationRequest struct {
	...
	// Wall-clock duration of the failed attempt as measured by the worker.
...
func (x *FailActivationRequest) GetLatencyMs() int64 {
	if x != nil {
		return x.LatencyMs
	}
	return 0
...
const file_api_v1_engine_proto_rawDesc = "" +
	...
	"\apayload\x18\x04 \x01(\v2\x19.api.v1.ActivationPayloadR\apayload\"\xde\x01\n" +
	...
	"\rcached_tokens\x18\a \x01(\x03R\fcachedTokens\"\x86\x01\n" +
	...
	"\x05child\x18\f \x01(\v2\x1e.api.v1.ChildActivationLinkageR\x05child\x12!\n" +
	"\fdisplay_name\x18\r \x01(\tR\vdisplayName\x12\x1d\n" +
	"\n" +
	"input_data\x18\x0e \x01(\fR\tinputData\"\xd5\x02\n" +
	...
	"\x17accepted_journal_offset\x18\x05 \x01(\x04R\x15acceptedJournalOffset\"\xe5\x03\n" +
	...
	"\bevidence\x18\n" +
	" \x03(\v2\x1a.api.v1.ActivationEvidenceR\bevidence\x12\x1d\n" +
	"\n" +
	"latency_ms\x18\v \x01(\x03R\tlatencyMs\"\xf9\x01\n" +
	...
	"\btimer_id\x18\x06 \x01(\tR\atimerId\"\xfe\x01\n" +
