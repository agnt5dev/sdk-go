...
type CompleteJobRequest struct {
	...
	// Lifecycle records the worker deferred while `pull_completion_lifecycle_v1`
	// was negotiated: run.started, <component>.started, handler journal events,
	// and <component>.completed|failed, in emission order. The runtime appends
	// them in one atomic batch at offsets below the fenced completion request,
	// then appends the request. Records must belong to this project and run and
	// must not be terminal, another `run.*` lifecycle event, runtime-internal,
	// an activation record, or `workflow.state.changed`. Ignored when this
	// lease's completion is already projected. Max 32 records / 256 KiB.
	LifecycleRecords []*Record `protobuf:"bytes,12,rep,name=lifecycle_records,json=lifecycleRecords,proto3" json:"lifecycle_records,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CompleteJobRequest) GetLifecycleRecords() []*Record {
	if x != nil {
		return x.LifecycleRecords
	}
	return nil
}
...
type CompleteJobResponse struct {
	...
	// Lifecycle records newly written by this call. A retried CompleteJob
	// resolves duplicates to their earlier offsets and does not count them.
	LifecycleWrittenCount uint32 `protobuf:"varint,2,opt,name=lifecycle_written_count,json=lifecycleWrittenCount,proto3" json:"lifecycle_written_count,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *CompleteJobResponse) GetLifecycleWrittenCount() uint32 {
	if x != nil {
		return x.LifecycleWrittenCount
	}
	return 0
}
...
const file_api_v1_engine_proto_rawDesc = "" +
	...
	"\x0erecorded_at_ms\x18\x02 \x01(\x03R\frecordedAtMs\"\x98\x04\n" +
	...
	"\aattempt\x18\v \x01(\rH\x00R\aattempt\x88\x01\x01\x12;\n" +
	"\x11lifecycle_records\x18\f \x03(\v2\x0e.api.v1.RecordR\x10lifecycleRecords\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x17lifecycle_written_count\x18\x02 \x01(\rR\x15lifecycleWrittenCount*\xbc\x01\n" +
...
var file_api_v1_engine_proto_depIdxs = []int32{
	...
	9,   // 127: api.v1.CompleteJobRequest.lifecycle_records:type_name -> api.v1.Record
	10,  // 128: api.v1.EngineService.Append:input_type -> api.v1.AppendRequest
	12,  // 129: api.v1.EngineService.AppendBatch:input_type -> api.v1.AppendBatchRequest
	100, // 130: api.v1.EngineService.Checkpoint:input_type -> api.v1.CheckpointRequest
	110, // 131: api.v1.EngineService.BeginActivation:input_type -> api.v1.BeginActivationRequest
	115, // 132: api.v1.EngineService.CompleteActivation:input_type -> api.v1.CompleteActivationRequest
	117, // 133: api.v1.EngineService.FailActivation:input_type -> api.v1.FailActivationRequest
	119, // 134: api.v1.EngineService.SuspendActivation:input_type -> api.v1.SuspendActivationRequest
	129, // 135: api.v1.EngineService.EventStream:input_type -> api.v1.EventStreamMessage
	131, // 136: api.v1.EngineService.PollJobs:input_type -> api.v1.PollJobsRequest
	134, // 137: api.v1.EngineService.RegisterWorkerSession:input_type -> api.v1.RegisterWorkerSessionRequest
	136, // 138: api.v1.EngineService.PollJob:input_type -> api.v1.PollJobRequest
	139, // 139: api.v1.EngineService.RenewJobLease:input_type -> api.v1.RenewJobLeaseRequest
	141, // 140: api.v1.EngineService.ReportWorkerCapacity:input_type -> api.v1.ReportWorkerCapacityRequest
	143, // 141: api.v1.EngineService.CompleteJob:input_type -> api.v1.CompleteJobRequest
	14,  // 142: api.v1.EngineService.ReadByRunID:input_type -> api.v1.ReadByRunIDRequest
	16,  // 143: api.v1.EngineService.FindByStepKey:input_type -> api.v1.FindByStepKeyRequest
	18,  // 144: api.v1.EngineService.GetRun:input_type -> api.v1.GetRunRequest
	20,  // 145: api.v1.EngineService.ListRoutingWorkers:input_type -> api.v1.ListRoutingWorkersRequest
	24,  // 146: api.v1.EngineService.Tail:input_type -> api.v1.TailRequest
	49,  // 147: api.v1.EngineService.GetEntityState:input_type -> api.v1.GetEntityStateRequest
	51,  // 148: api.v1.EngineService.PutEntityState:input_type -> api.v1.PutEntityStateRequest
	54,  // 149: api.v1.EngineService.GetApproval:input_type -> api.v1.GetApprovalRequest
	56,  // 150: api.v1.EngineService.ListApprovals:input_type -> api.v1.EngineListApprovalsRequest
	59,  // 151: api.v1.EngineService.GetSignal:input_type -> api.v1.GetSignalRequest
	61,  // 152: api.v1.EngineService.LookupSignal:input_type -> api.v1.LookupSignalRequest
	63,  // 153: api.v1.EngineService.ListSignals:input_type -> api.v1.ListSignalsRequest
	66,  // 154: api.v1.EngineService.GetTimer:input_type -> api.v1.GetTimerRequest
	68,  // 155: api.v1.EngineService.ListTimers:input_type -> api.v1.ListTimersRequest
	70,  // 156: api.v1.EngineService.ListDueTimers:input_type -> api.v1.ListDueTimersRequest
	73,  // 157: api.v1.EngineService.GetJob:input_type -> api.v1.GetJobRequest
	75,  // 158: api.v1.EngineService.ListJobsByRun:input_type -> api.v1.ListJobsByRunRequest
	77,  // 159: api.v1.EngineService.ListJobsByBatch:input_type -> api.v1.ListJobsByBatchRequest
	80,  // 160: api.v1.EngineService.GetBatch:input_type -> api.v1.GetBatchRequest
	83,  // 161: api.v1.EngineService.GetSession:input_type -> api.v1.GetSessionRequest
	85,  // 162: api.v1.EngineService.ListSessions:input_type -> api.v1.ListSessionsRequest
	88,  // 163: api.v1.EngineService.GetMessage:input_type -> api.v1.GetMessageRequest
	90,  // 164: api.v1.EngineService.ListMessagesByCorrelation:input_type -> api.v1.ListMessagesByCorrelationRequest
	92,  // 165: api.v1.EngineService.ListRuns:input_type -> api.v1.ListRunsRequest
	97,  // 166: api.v1.EngineService.GetRunStats:input_type -> api.v1.GetRunStatsRequest
	94,  // 167: api.v1.EngineService.ListEvents:input_type -> api.v1.ListEventsRequest
	26,  // 168: api.v1.EngineService.GetStatus:input_type -> api.v1.GetStatusRequest
	28,  // 169: api.v1.ReplicationService.Store:input_type -> api.v1.StoreRequest
	30,  // 170: api.v1.ReplicationService.GetRecords:input_type -> api.v1.GetRecordsRequest
	32,  // 171: api.v1.ReplicationService.Seal:input_type -> api.v1.SealRequest
	34,  // 172: api.v1.ReplicationService.Heartbeat:input_type -> api.v1.HeartbeatRequest
	37,  // 173: api.v1.ReplicationService.RequestVote:input_type -> api.v1.VoteRequest
	39,  // 174: api.v1.ReplicationService.AnnounceLeader:input_type -> api.v1.AnnounceLeaderRequest
	41,  // 175: api.v1.ReplicationService.ForwardAppend:input_type -> api.v1.ForwardAppendRequest
	41,  // 176: api.v1.ReplicationService.ForwardAppendV2:input_type -> api.v1.ForwardAppendRequest
	43,  // 177: api.v1.ReplicationService.AddMember:input_type -> api.v1.AddMemberRequest
	45,  // 178: api.v1.ReplicationService.RemoveMember:input_type -> api.v1.RemoveMemberRequest
	47,  // 179: api.v1.ReplicationService.TransferLeadership:input_type -> api.v1.TransferLeadershipRequest
	11,  // 180: api.v1.EngineService.Append:output_type -> api.v1.AppendResponse
	13,  // 181: api.v1.EngineService.AppendBatch:output_type -> api.v1.AppendBatchResponse
	101, // 182: api.v1.EngineService.Checkpoint:output_type -> api.v1.CheckpointResponse
	114, // 183: api.v1.EngineService.BeginActivation:output_type -> api.v1.BeginActivationResponse
	116, // 184: api.v1.EngineService.CompleteActivation:output_type -> api.v1.CompleteActivationResponse
	118, // 185: api.v1.EngineService.FailActivation:output_type -> api.v1.FailActivationResponse
	120, // 186: api.v1.EngineService.SuspendActivation:output_type -> api.v1.SuspendActivationResponse
	130, // 187: api.v1.EngineService.EventStream:output_type -> api.v1.EventStreamAck
	132, // 188: api.v1.EngineService.PollJobs:output_type -> api.v1.PollJobsResponse
	135, // 189: api.v1.EngineService.RegisterWorkerSession:output_type -> api.v1.RegisterWorkerSessionResponse
	137, // 190: api.v1.EngineService.PollJob:output_type -> api.v1.PollJobResponse
	140, // 191: api.v1.EngineService.RenewJobLease:output_type -> api.v1.RenewJobLeaseResponse
	142, // 192: api.v1.EngineService.ReportWorkerCapacity:output_type -> api.v1.ReportWorkerCapacityResponse
	144, // 193: api.v1.EngineService.CompleteJob:output_type -> api.v1.CompleteJobResponse
	15,  // 194: api.v1.EngineService.ReadByRunID:output_type -> api.v1.ReadByRunIDResponse
	17,  // 195: api.v1.EngineService.FindByStepKey:output_type -> api.v1.FindByStepKeyResponse
	19,  // 196: api.v1.EngineService.GetRun:output_type -> api.v1.GetRunResponse
	21,  // 197: api.v1.EngineService.ListRoutingWorkers:output_type -> api.v1.ListRoutingWorkersResponse
	25,  // 198: api.v1.EngineService.Tail:output_type -> api.v1.TailResponse
	50,  // 199: api.v1.EngineService.GetEntityState:output_type -> api.v1.GetEntityStateResponse
	52,  // 200: api.v1.EngineService.PutEntityState:output_type -> api.v1.PutEntityStateResponse
	55,  // 201: api.v1.EngineService.GetApproval:output_type -> api.v1.GetApprovalResponse
	57,  // 202: api.v1.EngineService.ListApprovals:output_type -> api.v1.EngineListApprovalsResponse
	60,  // 203: api.v1.EngineService.GetSignal:output_type -> api.v1.GetSignalResponse
	62,  // 204: api.v1.EngineService.LookupSignal:output_type -> api.v1.LookupSignalResponse
	64,  // 205: api.v1.EngineService.ListSignals:output_type -> api.v1.ListSignalsResponse
	67,  // 206: api.v1.EngineService.GetTimer:output_type -> api.v1.GetTimerResponse
	69,  // 207: api.v1.EngineService.ListTimers:output_type -> api.v1.ListTimersResponse
	71,  // 208: api.v1.EngineService.ListDueTimers:output_type -> api.v1.ListDueTimersResponse
	74,  // 209: api.v1.EngineService.GetJob:output_type -> api.v1.GetJobResponse
	76,  // 210: api.v1.EngineService.ListJobsByRun:output_type -> api.v1.ListJobsByRunResponse
	78,  // 211: api.v1.EngineService.ListJobsByBatch:output_type -> api.v1.ListJobsByBatchResponse
	81,  // 212: api.v1.EngineService.GetBatch:output_type -> api.v1.GetBatchResponse
	84,  // 213: api.v1.EngineService.GetSession:output_type -> api.v1.GetSessionResponse
	86,  // 214: api.v1.EngineService.ListSessions:output_type -> api.v1.ListSessionsResponse
	89,  // 215: api.v1.EngineService.GetMessage:output_type -> api.v1.GetMessageResponse
	91,  // 216: api.v1.EngineService.ListMessagesByCorrelation:output_type -> api.v1.ListMessagesByCorrelationResponse
	93,  // 217: api.v1.EngineService.ListRuns:output_type -> api.v1.ListRunsResponse
	98,  // 218: api.v1.EngineService.GetRunStats:output_type -> api.v1.GetRunStatsResponse
	96,  // 219: api.v1.EngineService.ListEvents:output_type -> api.v1.ListEventsResponse
	27,  // 220: api.v1.EngineService.GetStatus:output_type -> api.v1.GetStatusResponse
	29,  // 221: api.v1.ReplicationService.Store:output_type -> api.v1.StoreResponse
	31,  // 222: api.v1.ReplicationService.GetRecords:output_type -> api.v1.GetRecordsResponse
	33,  // 223: api.v1.ReplicationService.Seal:output_type -> api.v1.SealResponse
	35,  // 224: api.v1.ReplicationService.Heartbeat:output_type -> api.v1.HeartbeatResponse
	38,  // 225: api.v1.ReplicationService.RequestVote:output_type -> api.v1.VoteResponse
	40,  // 226: api.v1.ReplicationService.AnnounceLeader:output_type -> api.v1.AnnounceLeaderResponse
	42,  // 227: api.v1.ReplicationService.ForwardAppend:output_type -> api.v1.ForwardAppendResponse
	42,  // 228: api.v1.ReplicationService.ForwardAppendV2:output_type -> api.v1.ForwardAppendResponse
	44,  // 229: api.v1.ReplicationService.AddMember:output_type -> api.v1.AddMemberResponse
	46,  // 230: api.v1.ReplicationService.RemoveMember:output_type -> api.v1.RemoveMemberResponse
	48,  // 231: api.v1.ReplicationService.TransferLeadership:output_type -> api.v1.TransferLeadershipResponse
	180, // [180:232] is the sub-list for method output_type
	128, // [128:180] is the sub-list for method input_type
