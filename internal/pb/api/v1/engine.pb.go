...
const file_api_v1_engine_proto_rawDesc = "" +
	...
	",ACTIVATION_ERROR_CODE_STATE_VERSION_CONFLICT\x10\t*\xd9\x01\n" +
	...
	"&LEASE_RENEWAL_OUTCOME_SESSION_INACTIVE\x10\x042\xb1\x17\n" +
	"\rEngineService\x127\n" +
...
var file_api_v1_engine_proto_goTypes = []any{
	...
	(*ActivationStartedRecord)(nil),           // 117: api.v1.ActivationStartedRecord
	(*ActivationCompletedRecord)(nil),         // 118: api.v1.ActivationCompletedRecord
	(*ActivationFailedRecord)(nil),            // 119: api.v1.ActivationFailedRecord
	(*ActivationSuspendedRecord)(nil),         // 120: api.v1.ActivationSuspendedRecord
	(*ActivationCancelledRecord)(nil),         // 121: api.v1.ActivationCancelledRecord
	(*ActivationUnknownOutcomeRecord)(nil),    // 122: api.v1.ActivationUnknownOutcomeRecord
	(*ActivationSnapshotRecord)(nil),          // 123: api.v1.ActivationSnapshotRecord
	(*ActivationJournalRecord)(nil),           // 124: api.v1.ActivationJournalRecord
	(*EventStreamMessage)(nil),                // 125: api.v1.EventStreamMessage
	(*EventStreamAck)(nil),                    // 126: api.v1.EventStreamAck
	(*PollJobsRequest)(nil),                   // 127: api.v1.PollJobsRequest
	(*PollJobsResponse)(nil),                  // 128: api.v1.PollJobsResponse
	(*WorkerSlotPolicy)(nil),                  // 129: api.v1.WorkerSlotPolicy
	(*RegisterWorkerSessionRequest)(nil),      // 130: api.v1.RegisterWorkerSessionRequest
	(*RegisterWorkerSessionResponse)(nil),     // 131: api.v1.RegisterWorkerSessionResponse
	(*PollJobRequest)(nil),                    // 132: api.v1.PollJobRequest
	(*PollJobResponse)(nil),                   // 133: api.v1.PollJobResponse
	(*JobAssignment)(nil),                     // 134: api.v1.JobAssignment
	(*RenewJobLeaseRequest)(nil),              // 135: api.v1.RenewJobLeaseRequest
	(*RenewJobLeaseResponse)(nil),             // 136: api.v1.RenewJobLeaseResponse
	(*ReportWorkerCapacityRequest)(nil),       // 137: api.v1.ReportWorkerCapacityRequest
	(*ReportWorkerCapacityResponse)(nil),      // 138: api.v1.ReportWorkerCapacityResponse
	(*CompleteJobRequest)(nil),                // 139: api.v1.CompleteJobRequest
	(*CompleteJobResponse)(nil),               // 140: api.v1.CompleteJobResponse
	nil,                                       // 141: api.v1.Record.MetadataEntry
	nil,                                       // 142: api.v1.Run.MetadataEntry
	nil,                                       // 143: api.v1.Job.MetadataEntry
	nil,                                       // 144: api.v1.GetRunStatsResponse.CountByStatusEntry
	nil,                                       // 145: api.v1.GetRunStatsResponse.CountByComponentTypeEntry
	nil,                                       // 146: api.v1.JobAssignment.MetadataEntry
	nil,                                       // 147: api.v1.CompleteJobRequest.MetadataEntry
	(*WorkerInfo)(nil),                        // 148: api.v1.WorkerInfo
	(*timestamppb.Timestamp)(nil),             // 149: google.protobuf.Timestamp
	(Priority)(0),                             // 150: api.v1.Priority
	(*WorkerCapability)(nil),                  // 151: api.v1.WorkerCapability
	(*ComponentInfo)(nil),                     // 152: api.v1.ComponentInfo
	(ComponentType)(0),                        // 153: api.v1.ComponentType
	(WorkerMode)(0),                           // 154: api.v1.WorkerMode
}
var file_api_v1_engine_proto_depIdxs = []int32{
	141, // 0: api.v1.Record.metadata:type_name -> api.v1.Record.MetadataEntry
	...
	148, // 6: api.v1.ListRoutingWorkersResponse.workers:type_name -> api.v1.WorkerInfo
	149, // 7: api.v1.Run.submitted_at:type_name -> google.protobuf.Timestamp
	149, // 8: api.v1.Run.started_at:type_name -> google.protobuf.Timestamp
	149, // 9: api.v1.Run.completed_at:type_name -> google.protobuf.Timestamp
	149, // 10: api.v1.Run.gateway_received_at:type_name -> google.protobuf.Timestamp
	149, // 11: api.v1.Run.assigned_at:type_name -> google.protobuf.Timestamp
	142, // 12: api.v1.Run.metadata:type_name -> api.v1.Run.MetadataEntry
	150, // 13: api.v1.Run.priority:type_name -> api.v1.Priority
	...
	149, // 21: api.v1.Approval.requested_at:type_name -> google.protobuf.Timestamp
	149, // 22: api.v1.Approval.expires_at:type_name -> google.protobuf.Timestamp
	149, // 23: api.v1.Approval.decided_at:type_name -> google.protobuf.Timestamp
	...
	149, // 26: api.v1.Signal.received_at:type_name -> google.protobuf.Timestamp
	149, // 27: api.v1.Signal.acknowledged_at:type_name -> google.protobuf.Timestamp
	149, // 28: api.v1.Signal.expires_at:type_name -> google.protobuf.Timestamp
	...
	149, // 32: api.v1.Timer.fire_at:type_name -> google.protobuf.Timestamp
	149, // 33: api.v1.Timer.fired_at:type_name -> google.protobuf.Timestamp
	149, // 34: api.v1.Timer.canceled_at:type_name -> google.protobuf.Timestamp
	149, // 35: api.v1.Timer.expired_at:type_name -> google.protobuf.Timestamp
	...
	143, // 39: api.v1.Job.metadata:type_name -> api.v1.Job.MetadataEntry
	149, // 40: api.v1.Job.created_at:type_name -> google.protobuf.Timestamp
	149, // 41: api.v1.Job.claimed_at:type_name -> google.protobuf.Timestamp
	149, // 42: api.v1.Job.completed_at:type_name -> google.protobuf.Timestamp
	...
	149, // 46: api.v1.Batch.submitted_at:type_name -> google.protobuf.Timestamp
	149, // 47: api.v1.Batch.started_at:type_name -> google.protobuf.Timestamp
	149, // 48: api.v1.Batch.completed_at:type_name -> google.protobuf.Timestamp
	78,  // 49: api.v1.GetBatchResponse.batch:type_name -> api.v1.Batch
	149, // 50: api.v1.Session.created_at:type_name -> google.protobuf.Timestamp
	149, // 51: api.v1.Session.updated_at:type_name -> google.protobuf.Timestamp
	149, // 52: api.v1.Session.last_used_at:type_name -> google.protobuf.Timestamp
	149, // 53: api.v1.Session.expires_at:type_name -> google.protobuf.Timestamp
	...
	149, // 56: api.v1.ChatMessage.scheduled_at:type_name -> google.protobuf.Timestamp
	149, // 57: api.v1.ChatMessage.delivered_at:type_name -> google.protobuf.Timestamp
	149, // 58: api.v1.ChatMessage.created_at:type_name -> google.protobuf.Timestamp
	...
	144, // 63: api.v1.GetRunStatsResponse.count_by_status:type_name -> api.v1.GetRunStatsResponse.CountByStatusEntry
	145, // 64: api.v1.GetRunStatsResponse.count_by_component_type:type_name -> api.v1.GetRunStatsResponse.CountByComponentTypeEntry
	...
	119, // 99: api.v1.ActivationUnknownOutcomeRecord.failure:type_name -> api.v1.ActivationFailedRecord
	5,   // 100: api.v1.ActivationSnapshotRecord.status:type_name -> api.v1.ActivationStatus
	117, // 101: api.v1.ActivationSnapshotRecord.current_attempt:type_name -> api.v1.ActivationStartedRecord
	118, // 102: api.v1.ActivationSnapshotRecord.completion:type_name -> api.v1.ActivationCompletedRecord
	119, // 103: api.v1.ActivationSnapshotRecord.failure:type_name -> api.v1.ActivationFailedRecord
	120, // 104: api.v1.ActivationSnapshotRecord.suspension:type_name -> api.v1.ActivationSuspendedRecord
	121, // 105: api.v1.ActivationSnapshotRecord.cancellation:type_name -> api.v1.ActivationCancelledRecord
	117, // 106: api.v1.ActivationJournalRecord.started:type_name -> api.v1.ActivationStartedRecord
	118, // 107: api.v1.ActivationJournalRecord.completed:type_name -> api.v1.ActivationCompletedRecord
	119, // 108: api.v1.ActivationJournalRecord.failed:type_name -> api.v1.ActivationFailedRecord
	120, // 109: api.v1.ActivationJournalRecord.suspended:type_name -> api.v1.ActivationSuspendedRecord
	121, // 110: api.v1.ActivationJournalRecord.cancelled:type_name -> api.v1.ActivationCancelledRecord
	123, // 111: api.v1.ActivationJournalRecord.snapshot:type_name -> api.v1.ActivationSnapshotRecord
	122, // 112: api.v1.ActivationJournalRecord.unknown_outcome:type_name -> api.v1.ActivationUnknownOutcomeRecord
	134, // 113: api.v1.PollJobsResponse.jobs:type_name -> api.v1.JobAssignment
	129, // 114: api.v1.RegisterWorkerSessionRequest.slot_policy:type_name -> api.v1.WorkerSlotPolicy
	151, // 115: api.v1.RegisterWorkerSessionRequest.capabilities:type_name -> api.v1.WorkerCapability
	152, // 116: api.v1.RegisterWorkerSessionRequest.components:type_name -> api.v1.ComponentInfo
	129, // 117: api.v1.RegisterWorkerSessionResponse.effective_slot_policy:type_name -> api.v1.WorkerSlotPolicy
	134, // 118: api.v1.PollJobResponse.job:type_name -> api.v1.JobAssignment
	153, // 119: api.v1.JobAssignment.component_type:type_name -> api.v1.ComponentType
	146, // 120: api.v1.JobAssignment.metadata:type_name -> api.v1.JobAssignment.MetadataEntry
	154, // 121: api.v1.RenewJobLeaseRequest.mode:type_name -> api.v1.WorkerMode
	7,   // 122: api.v1.RenewJobLeaseResponse.outcome:type_name -> api.v1.LeaseRenewalOutcome
	147, // 123: api.v1.CompleteJobRequest.metadata:type_name -> api.v1.CompleteJobRequest.MetadataEntry
	...
	125, // 130: api.v1.EngineService.EventStream:input_type -> api.v1.EventStreamMessage
	127, // 131: api.v1.EngineService.PollJobs:input_type -> api.v1.PollJobsRequest
	130, // 132: api.v1.EngineService.RegisterWorkerSession:input_type -> api.v1.RegisterWorkerSessionRequest
	132, // 133: api.v1.EngineService.PollJob:input_type -> api.v1.PollJobRequest
	135, // 134: api.v1.EngineService.RenewJobLease:input_type -> api.v1.RenewJobLeaseRequest
	137, // 135: api.v1.EngineService.ReportWorkerCapacity:input_type -> api.v1.ReportWorkerCapacityRequest
	139, // 136: api.v1.EngineService.CompleteJob:input_type -> api.v1.CompleteJobRequest
	13,  // 137: api.v1.EngineService.ReadByRunID:input_type -> api.v1.ReadByRunIDRequest
	15,  // 138: api.v1.EngineService.FindByStepKey:input_type -> api.v1.FindByStepKeyRequest
	17,  // 139: api.v1.EngineService.GetRun:input_type -> api.v1.GetRunRequest
	19,  // 140: api.v1.EngineService.ListRoutingWorkers:input_type -> api.v1.ListRoutingWorkersRequest
	23,  // 141: api.v1.EngineService.Tail:input_type -> api.v1.TailRequest
	48,  // 142: api.v1.EngineService.GetEntityState:input_type -> api.v1.GetEntityStateRequest
	50,  // 143: api.v1.EngineService.PutEntityState:input_type -> api.v1.PutEntityStateRequest
	53,  // 144: api.v1.EngineService.GetApproval:input_type -> api.v1.GetApprovalRequest
	55,  // 145: api.v1.EngineService.ListApprovals:input_type -> api.v1.EngineListApprovalsRequest
	58,  // 146: api.v1.EngineService.GetSignal:input_type -> api.v1.GetSignalRequest
	60,  // 147: api.v1.EngineService.LookupSignal:input_type -> api.v1.LookupSignalRequest
	62,  // 148: api.v1.EngineService.ListSignals:input_type -> api.v1.ListSignalsRequest
	65,  // 149: api.v1.EngineService.GetTimer:input_type -> api.v1.GetTimerRequest
	67,  // 150: api.v1.EngineService.ListTimers:input_type -> api.v1.ListTimersRequest
	69,  // 151: api.v1.EngineService.ListDueTimers:input_type -> api.v1.ListDueTimersRequest
	72,  // 152: api.v1.EngineService.GetJob:input_type -> api.v1.GetJobRequest
	74,  // 153: api.v1.EngineService.ListJobsByRun:input_type -> api.v1.ListJobsByRunRequest
	76,  // 154: api.v1.EngineService.ListJobsByBatch:input_type -> api.v1.ListJobsByBatchRequest
	79,  // 155: api.v1.EngineService.GetBatch:input_type -> api.v1.GetBatchRequest
	82,  // 156: api.v1.EngineService.GetSession:input_type -> api.v1.GetSessionRequest
	84,  // 157: api.v1.EngineService.ListSessions:input_type -> api.v1.ListSessionsRequest
	87,  // 158: api.v1.EngineService.GetMessage:input_type -> api.v1.GetMessageRequest
	89,  // 159: api.v1.EngineService.ListMessagesByCorrelation:input_type -> api.v1.ListMessagesByCorrelationRequest
	91,  // 160: api.v1.EngineService.ListRuns:input_type -> api.v1.ListRunsRequest
	96,  // 161: api.v1.EngineService.GetRunStats:input_type -> api.v1.GetRunStatsRequest
	93,  // 162: api.v1.EngineService.ListEvents:input_type -> api.v1.ListEventsRequest
	25,  // 163: api.v1.EngineService.GetStatus:input_type -> api.v1.GetStatusRequest
	27,  // 164: api.v1.ReplicationService.Store:input_type -> api.v1.StoreRequest
	29,  // 165: api.v1.ReplicationService.GetRecords:input_type -> api.v1.GetRecordsRequest
	31,  // 166: api.v1.ReplicationService.Seal:input_type -> api.v1.SealRequest
	33,  // 167: api.v1.ReplicationService.Heartbeat:input_type -> api.v1.HeartbeatRequest
	36,  // 168: api.v1.ReplicationService.RequestVote:input_type -> api.v1.VoteRequest
	38,  // 169: api.v1.ReplicationService.AnnounceLeader:input_type -> api.v1.AnnounceLeaderRequest
	40,  // 170: api.v1.ReplicationService.ForwardAppend:input_type -> api.v1.ForwardAppendRequest
	40,  // 171: api.v1.ReplicationService.ForwardAppendV2:input_type -> api.v1.ForwardAppendRequest
	42,  // 172: api.v1.ReplicationService.AddMember:input_type -> api.v1.AddMemberRequest
	44,  // 173: api.v1.ReplicationService.RemoveMember:input_type -> api.v1.RemoveMemberRequest
	46,  // 174: api.v1.ReplicationService.TransferLeadership:input_type -> api.v1.TransferLeadershipRequest
	10,  // 175: api.v1.EngineService.Append:output_type -> api.v1.AppendResponse
	12,  // 176: api.v1.EngineService.AppendBatch:output_type -> api.v1.AppendBatchResponse
	100, // 177: api.v1.EngineService.Checkpoint:output_type -> api.v1.CheckpointResponse
	112, // 178: api.v1.EngineService.BeginActivation:output_type -> api.v1.BeginActivationResponse
	114, // 179: api.v1.EngineService.CompleteActivation:output_type -> api.v1.CompleteActivationResponse
	116, // 180: api.v1.EngineService.FailActivation:output_type -> api.v1.FailActivationResponse
	126, // 181: api.v1.EngineService.EventStream:output_type -> api.v1.EventStreamAck
	128, // 182: api.v1.EngineService.PollJobs:output_type -> api.v1.PollJobsResponse
	131, // 183: api.v1.EngineService.RegisterWorkerSession:output_type -> api.v1.RegisterWorkerSessionResponse
	133, // 184: api.v1.EngineService.PollJob:output_type -> api.v1.PollJobResponse
	136, // 185: api.v1.EngineService.RenewJobLease:output_type -> api.v1.RenewJobLeaseResponse
	138, // 186: api.v1.EngineService.ReportWorkerCapacity:output_type -> api.v1.ReportWorkerCapacityResponse
	140, // 187: api.v1.EngineService.CompleteJob:output_type -> api.v1.CompleteJobResponse
	14,  // 188: api.v1.EngineService.ReadByRunID:output_type -> api.v1.ReadByRunIDResponse
	16,  // 189: api.v1.EngineService.FindByStepKey:output_type -> api.v1.FindByStepKeyResponse
	18,  // 190: api.v1.EngineService.GetRun:output_type -> api.v1.GetRunResponse
	20,  // 191: api.v1.EngineService.ListRoutingWorkers:output_type -> api.v1.ListRoutingWorkersResponse
	24,  // 192: api.v1.EngineService.Tail:output_type -> api.v1.TailResponse
	49,  // 193: api.v1.EngineService.GetEntityState:output_type -> api.v1.GetEntityStateResponse
	51,  // 194: api.v1.EngineService.PutEntityState:output_type -> api.v1.PutEntityStateResponse
	54,  // 195: api.v1.EngineService.GetApproval:output_type -> api.v1.GetApprovalResponse
	56,  // 196: api.v1.EngineService.ListApprovals:output_type -> api.v1.EngineListApprovalsResponse
	59,  // 197: api.v1.EngineService.GetSignal:output_type -> api.v1.GetSignalResponse
	61,  // 198: api.v1.EngineService.LookupSignal:output_type -> api.v1.LookupSignalResponse
	63,  // 199: api.v1.EngineService.ListSignals:output_type -> api.v1.ListSignalsResponse
	66,  // 200: api.v1.EngineService.GetTimer:output_type -> api.v1.GetTimerResponse
	68,  // 201: api.v1.EngineService.ListTimers:output_type -> api.v1.ListTimersResponse
	70,  // 202: api.v1.EngineService.ListDueTimers:output_type -> api.v1.ListDueTimersResponse
	73,  // 203: api.v1.EngineService.GetJob:output_type -> api.v1.GetJobResponse
	75,  // 204: api.v1.EngineService.ListJobsByRun:output_type -> api.v1.ListJobsByRunResponse
	77,  // 205: api.v1.EngineService.ListJobsByBatch:output_type -> api.v1.ListJobsByBatchResponse
	80,  // 206: api.v1.EngineService.GetBatch:output_type -> api.v1.GetBatchResponse
	83,  // 207: api.v1.EngineService.GetSession:output_type -> api.v1.GetSessionResponse
	85,  // 208: api.v1.EngineService.ListSessions:output_type -> api.v1.ListSessionsResponse
	88,  // 209: api.v1.EngineService.GetMessage:output_type -> api.v1.GetMessageResponse
	90,  // 210: api.v1.EngineService.ListMessagesByCorrelation:output_type -> api.v1.ListMessagesByCorrelationResponse
	92,  // 211: api.v1.EngineService.ListRuns:output_type -> api.v1.ListRunsResponse
	97,  // 212: api.v1.EngineService.GetRunStats:output_type -> api.v1.GetRunStatsResponse
	95,  // 213: api.v1.EngineService.ListEvents:output_type -> api.v1.ListEventsResponse
	26,  // 214: api.v1.EngineService.GetStatus:output_type -> api.v1.GetStatusResponse
	28,  // 215: api.v1.ReplicationService.Store:output_type -> api.v1.StoreResponse
	30,  // 216: api.v1.ReplicationService.GetRecords:output_type -> api.v1.GetRecordsResponse
	32,  // 217: api.v1.ReplicationService.Seal:output_type -> api.v1.SealResponse
	34,  // 218: api.v1.ReplicationService.Heartbeat:output_type -> api.v1.HeartbeatResponse
	37,  // 219: api.v1.ReplicationService.RequestVote:output_type -> api.v1.VoteResponse
	39,  // 220: api.v1.ReplicationService.AnnounceLeader:output_type -> api.v1.AnnounceLeaderResponse
	41,  // 221: api.v1.ReplicationService.ForwardAppend:output_type -> api.v1.ForwardAppendResponse
	41,  // 222: api.v1.ReplicationService.ForwardAppendV2:output_type -> api.v1.ForwardAppendResponse
	43,  // 223: api.v1.ReplicationService.AddMember:output_type -> api.v1.AddMemberResponse
	45,  // 224: api.v1.ReplicationService.RemoveMember:output_type -> api.v1.RemoveMemberResponse
	47,  // 225: api.v1.ReplicationService.TransferLeadership:output_type -> api.v1.TransferLeadershipResponse
	175, // [175:226] is the sub-list for method output_type
	124, // [124:175] is the sub-list for method input_type
